...
<?php echo $this->Form->create('SurveyAnswer'); ?>
	<fieldset>
		<legend><?php echo __('Edit Survey Answer'); ?></legend>
	<?php
...
<div class="actions">
	...
	<ul>
		...
		<li><?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $this->Form->value('SurveyAnswer.id')), null, __('Are you sure you want to delete # %s?', $this->Form->value('SurveyAnswer.id'))); ?></li>
